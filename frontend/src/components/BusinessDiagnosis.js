...
export default function BusinessDiagnosis() {
    ...
    useEffect(() => {
        setMessages([{
            role: 'assistant',
            content: 'Oi, leoa! 🦁 Vamos começar seu Diagnóstico de Negócio para destravar seus resultados.\n\nPara começarmos, me conte: qual é o **nome do seu negócio** e qual o **nicho exato** que você atua?'
        }]);
    }, []);
